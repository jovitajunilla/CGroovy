export const songData = [{
        ...
        lyrics:`Jaga dulu jarak kita
                ...
                Jangan minta jatuh cinta (jatuh cinta)
                Luka lama ku juga belum reda
                Beri dulu aku waktu untuk sembuh sendirinya (sembuh sendirinya)
                Jangan minta jatuh cinta
                Sakit sebelumnya masih kurasa
                Beri waktu hingga aku mampu lupakan semua
        ...
        lyrics:`Kucoba sampaikan semua ini
                ...
                Andaikan kau ada
                Andaikan kau tahu, oh

                Ku tak sanggup menahan beban ini
                Yang selalu kau anggap semua angin lalu
                Andaikan kau ada, andaikan kau tahu
                Akan problemaku, dan s'lalu di sisiku

                Ku ingin kau ada, ku ingin kau tahu
                Mengertilah, oh, kasih
                Berikan waktumu, oh-ho

                Ku ingin kau ada, ku ingin kau tahu
                Mengertilah, oh, kasih
                Dan cobalah untuk mengerti

                Kini diriku telah lelah menanti
                Menantikan hadirnya dirimu
                Dan kuakhiri kisah cinta ini
                Lupakan semua, tinggalkan dirimu, oh, kasih
